...
\item Ein Spiel startet nun, wenn die maximale Anzahl der Clienten auf einem Server verbunden ist, statt bei variabler Anzahl mit "Bereit-Option" starten zu k"onnen
\item Es gibt keine M"oglichkeit, aktiv ein Spiel aufzugeben (/F12080/)
\item Ein AIClient kann dem Server hinzugef"ugt werden, anstatt dass dieser als eigenes Programm gestarted wird dass sich auf den Server verbindet
\item Es ist nicht m"oglich einem angefangenen Spiel (wieder) beizutreten
